...
public class Food1 {
    ...
    public Food1(String name, int image, int price) {
        this.name = name;
        this.image = image;
        this.price = price;
    }

    public static ArrayList<Food1> getFood1Data() {
        ...
        ArrayList<Food1> food1s = new ArrayList<>();
        for (int i = 0; i < names.length; i++) {
            food1s.add(new Food1(names[i], images[i], prices[i]));
        }
        return food1s;
    }
}
